...
function ChallengeCard({ challenge }: { challenge: ChallengeProduct }) {
  ...
  return (
    <div className={`group relative flex h-full flex-col rounded-3xl border p-6 backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 ${challenge.is_popular ? "border-[#D4AF37]/50 bg-[#D4AF37]/[0.05] shadow-[0_0_50px_rgba(212,175,55,0.15)] hover:border-[#D4AF37]/70 hover:shadow-[0_25px_70px_rgba(212,175,55,0.25)]" : "border-[#D4AF37]/15 bg-white/[0.02] hover:border-[#D4AF37]/50 hover:bg-white/[0.04] hover:shadow-[0_20px_60px_rgba(212,175,55,0.15)]"} ${comingSoon ? "opacity-80" : ""}`}>
      ...
      {comingSoon ? (
        ...
        <div>
          ...
          <p className="mt-1 text-3xl font-extrabold text-[#D4AF37]">N{challenge.challenge_fee!.toLocaleString()}</p>
        </div>
      )}
      <div className="my-5 h-px bg-[#D4AF37]/10" />
  ...
  return (
    <section className="relative overflow-hidden bg-black py-24">
      ...
      <div className="relative mx-auto max-w-[1440px] px-8">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory -mx-8 px-8 sm:hidden [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: "none" }}>

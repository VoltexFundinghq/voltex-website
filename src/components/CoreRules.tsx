...
const rules = [
  ...
  { value: 3, suffix: " Min", title: "Minimum Hold Time", description: "Every position must remain open for at least three minutes to encourage genuine trading and prevent latency arbitrage.", bullets: ["Fair execution", "Discourages abuse", "Promotes consistency"], icon: Clock3, featured: false },
  ...
  return (
    <section className="relative overflow-hidden bg-black pt-20 pb-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <motion.div initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mx-auto mb-8 max-w-3xl text-center">
        ...
        <div className="relative mx-auto mt-20 max-w-4xl">
          ...
          <motion.div initial={{ opacity: 0, y: 35 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.45 }} className="relative overflow-hidden rounded-[40px] border border-[#D4AF37]/25 bg-white/[0.03] p-10 text-center backdrop-blur-xl">
            ...
            <div className="relative">
              ...
              <Link href="/core-rules"><button className="mt-8 inline-flex items-center gap-3 rounded-2xl border border-[#D4AF37] bg-[#D4AF37]/10 px-8 py-4 text-sm font-bold text-[#D4AF37] transition-all duration-300 hover:bg-[#D4AF37] hover:text-black">View Complete Rules</button></Link>
            </div>
          </motion.div>
        </div>
      </div>

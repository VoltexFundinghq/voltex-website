...
export default function DashboardHeader() {
  ...
  // Live clock — updates every second, independent of data refresh
  useEffect(() => {
  ...
  // Genuine auto-refresh — re-fetches real page data on a timer,
  // independent of the clock display above.
  useEffect(() => {

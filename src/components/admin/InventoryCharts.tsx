...
export default function InventoryCharts({ data }: { data: InventoryCharts }) {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5">
        <h3 className="mb-3 text-sm font-semibold text-white">Inventory By Stage</h3>
        {hasStage ? (
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5">
        <h3 className="mb-3 text-sm font-semibold text-white">Inventory By Account Size</h3>
        {hasSize ? (
          <ResponsiveContainer width="100%" height={180}>

...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <svg className="pointer-events-none absolute inset-0 h-full w-full opacity-[0.18]" viewBox="0 0 1600 900" fill="none" preserveAspectRatio="none">
        ...
        <div className="max-w-xl">
          ...
          <div className="flex gap-4">
            <Link href="/challenges">
              <Button className="bg-[#D4AF37] px-8 py-4 text-lg text-black hover:bg-[#F5D573]">Start Challenge</Button>
            </Link>
            <Link href="/challenges">
              <Button className="border border-[#D4AF37] bg-transparent px-8 py-4 text-lg text-white hover:bg-[#D4AF37] hover:text-black">View Challenges</Button>
            </Link>
          </div>
        </div>

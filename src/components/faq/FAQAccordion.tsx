...
const faqData: Record<string, { q: string; a: string[] }[]> = {
  ...
  Challenge: [
    { q: "How do I become funded?", a: ["Every Voltex Funding account uses a two-phase evaluation model. First, choose a challenge account size that matches your trading style. Second, trade Phase 1 and grow your balance by 10% while respecting the maximum drawdown limit. Third, move on to Phase 2 and reach the same 10% target under the exact same rules.", "You trade on the same account for both phases — once you pass Phase 1, your balance simply resets to your original starting amount for Phase 2, so your full trading history stays visible in one place, and there's no new login to learn.", "Once you pass both phases without breaching any rules, your funded account is issued. The same maximum drawdown rule that applied in Phase 1 and Phase 2 continues to apply on your funded account too — nothing changes once you move to the next stage."] },
    { q: "What is the profit target?", a: ["The profit target is 10% of your account's starting balance, and it applies separately to Phase 1 and Phase 2 — you trade on the same account both times, with your balance resetting to the same original starting amount for Phase 2, so the 10% target is calculated fresh each time, not compounded on top of your Phase 1 ending balance.", "For example, on a N500,000 account, you'd need to reach N550,000 to pass Phase 1. Once you pass, your balance resets to N500,000 for Phase 2 on the same account, and you'll need to reach N550,000 again to complete Phase 2.", "There's no requirement to hit the target in a specific number of trades or days in either phase — consistency and risk management matter more than speed. For the full breakdown of every trading rule, see our Trading Rules page."] },
  ...
  Payouts: [
    ...
    { q: "How often can I request payouts?", a: ["You can request a payout as soon as your profit reaches the eligibility threshold of 10% of your account's starting balance.", "Once approved, your payout is processed as a withdrawal directly on your account — visible in your own MT5 history, the same as any transaction — which brings your balance back to your original starting amount so you can continue trading. Your funded account stays with you long-term; it isn't replaced or given a new login after each payout.", "After each payout is completed, a 72-hour cooldown applies before you can request your next payout."] },

...
export default function CoreRulesHero() {
  return (
    <section className="relative overflow-hidden bg-black pb-8 pt-16">
      ...
      <div className="relative mx-auto max-w-[1440px] px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-[#D4AF37]">CORE RULES</p>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight text-white md:text-5xl">The Rules Behind Every Voltex Account</h1>

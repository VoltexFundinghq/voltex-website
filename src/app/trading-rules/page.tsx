...
const coreRules = [
  ...
  { value: 3, suffix: " Min", title: "Minimum Hold Time", description: "Every position must remain open for at least three minutes to encourage genuine trading and prevent latency arbitrage.", bullets: ["Prevents latency abuse", "Encourages genuine execution", "Applies to every trade", "Up to 4 warnings are recorded — reach a 4th and your challenge is breached"], icon: Clock3, featured: false },

...
const coreRules = [
  { value: 20, suffix: "%", title: "Balance-Based Trailing Drawdown", description: "Your maximum allowed loss is calculated once, from your account's starting balance — 20% of your original size — and that amount never changes. Your floor still moves UP every time you close a trade at a new highest balance, but the fixed amount you're allowed to lose stays the same for the life of your account.", bullets: ["Fixed allowed-loss amount, calculated once from your starting balance", "Floor moves up with every new closed-trade high", "The allowed-loss window itself never grows, no matter how large your account gets", "Email alert at 15% down — before the 20% limit"], icon: ShieldCheck, featured: true },
  { value: 3, suffix: " Min", title: "Minimum Hold Time", description: "Every position must remain open for at least three minutes to encourage genuine trading and prevent latency arbitrage.", bullets: ["Prevents latency abuse", "Encourages genuine execution", "Applies to every trade", "Up to 4 warnings are recorded — reach a 4th and your challenge is breached", "We'll email you at your 2nd warning, giving you a clear heads-up before it's too late"], icon: Clock3, featured: false },
  { value: 5, suffix: " Days", title: "Activity Requirement", description: "Place at least one trade every five calendar days to keep your challenge active.", bullets: ["Stay active", "Simple requirement", "Fair capital allocation", "Warning email on day 4, before day 5"], icon: CalendarClock, featured: false },
];
const faqItems = [
  ...
  { q: "Maximum Drawdown", a: "Your maximum allowed loss is a FIXED amount, calculated once from your account's starting balance — 20% of your original size. This amount never grows, even as your account balance climbs. Your floor still moves up every time you close a trade at a new high, but the fixed loss window itself stays the same for the life of your account.", bullets: ["Fixed allowed-loss amount, calculated once as 20% of your STARTING balance", "Recalculates upward as your balance grows — but the window size never changes", "Checked against your real-time balance, including floating trades still open", "A floating dip to the floor is an immediate breach, even if the trade would have recovered", "This is your only overall limit — there is no separate daily drawdown rule", "You'll receive an early warning email at 15% down — a genuine heads-up before the 20% limit"], example: "On a N500,000 account, your fixed allowed loss is N100,000 — always. If your balance grows to N540,000, your floor becomes N440,000 (N540,000 minus the fixed N100,000) — not N432,000, which is what a percentage-of-peak model would give." },
  ...
  { q: "News Trading", a: "Trading around high-impact news events is allowed. The only requirement is a short holding period for any trade opened right before a release. Trades opened outside this specific window are never affected by this rule at all.", bullets: ["News trading is permitted, with no restriction on when you can enter a trade", "The rule ONLY applies to trades opened within 4 minutes before a high-impact release — a trade opened 5 minutes before, or any time earlier, is completely unaffected, no matter when it closes", "If a trade IS opened within that 4-minute window, it must stay open for at least 4 minutes after the release", "Violating this is a straight breach — your challenge fails immediately, with no warning stage", "This prevents entering right before a spike and closing the instant it hits, rather than genuinely trading the move"] },
  { q: "Weekend Holding", a: "Weekend trading is available on BTC/USD and ETH/USD, since these markets remain open on Saturdays and Sundays — these two instruments can be freely traded AND held open across the weekend with no restriction. Every other instrument must be closed before the weekend begins.", bullets: ["BTC/USD and ETH/USD are exempt — freely tradeable and holdable across the weekend", "Every other instrument still open during the weekend window counts as a violation", "Each individual open position is its own violation — holding several non-exempt positions at once counts separately for each one", "First occurrence: a warning. Second occurrence: a rule breach", "Exists to protect you and Voltex Funding from sharp weekend price gaps"] },
  ...
  { q: "Copy Trading", a: "Copy trading is allowed between multiple accounts you personally own, but not between accounts belonging to two different traders.", bullets: ["Allowed across your own multiple accounts", "Not allowed between two different traders' accounts", "Copying between different users is treated as a direct rule breach", "This same-account exception applies to copy trading only — reverse hedging between your own accounts is still prohibited, with no exception"] },
  { q: "Prohibited Trading Practices", a: "A few practices are never allowed on any Voltex Funding account:", bullets: ["Arbitrage, including latency arbitrage", "Latency exploitation of any kind", "Platform or execution abuse", "Account sharing or trading for someone else", "Reverse hedging across multiple accounts — including your own"] },
];

...
const coreRules = [
  ...
  { value: 5, suffix: " Days", title: "Activity Requirement", description: "Place at least one trade every five calendar days to keep your challenge active.", bullets: ["Stay active", "Simple requirement", "Fair capital allocation", "We'll email you a warning on day 4 of inactivity — one day's notice before a breach on day 5"], icon: CalendarClock, featured: false },
];
const faqItems = [

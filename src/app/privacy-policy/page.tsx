...
const sections = [
  ...
  { title: "2. Information We Collect", body: ["We may collect personal information you provide directly to us, including your name, email address, phone number, and billing information when you purchase a challenge.", "We may also collect information necessary to verify your identity and process payments, and trading activity data generated on your MetaTrader 5 (MT5) account for the purpose of evaluating your challenge or funded account.", "At the time of registration and at the time of purchasing a challenge, we also collect your IP address and device and browser information, together with a timestamped record of your agreement to our Terms of Service. This information is collected for fraud prevention and as evidence of informed consent to a completed transaction."] },
  ...
  { title: "4. Sharing Your Information", body: ["We may share your information with trusted third parties necessary to operate our services, such as our payment processor, PalmPay, and the trading platform provider (MetaTrader 5).", "In the event of a payment dispute or chargeback, we may share your registration and purchase records, including IP address, device information, and recorded consent to our Terms of Service, with our payment processor and relevant banking institutions as evidence of service delivery.", "We do not sell your personal information to third parties for marketing purposes."] },

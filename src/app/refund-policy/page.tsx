  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden bg-black pb-8 pt-16">
        ...
        <div className="relative mx-auto max-w-[900px] px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="mx-auto max-w-2xl text-center">
            ...
            <h1 className="mt-4 text-4xl font-extrabold leading-tight text-white md:text-5xl">Refund Policy</h1>
      ...
      <section className="relative overflow-hidden bg-black py-12">
        <div className="relative mx-auto max-w-[800px] px-8 space-y-10">

          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>
            <h2 className="text-lg font-extrabold text-white">Our Policy</h2>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.05 }} className="rounded-2xl border border-[#D4AF37]/20 bg-white/[0.02] p-7 backdrop-blur-xl">
            ...
            <ul className="mt-4 space-y-2.5 pl-1">
              {[
                "Change of mind after an account has been issued",
                "Failing Phase 1 or Phase 2 of your evaluation",
                "Breaching a trading rule, including drawdown or activity requirements",
                "Dissatisfaction with trading performance or results",
              ].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }} className="rounded-2xl border border-[#D4AF37]/20 bg-white/[0.02] p-7 backdrop-blur-xl">
            <div className="flex items-center gap-3">
            ...
            <ul className="mt-4 space-y-2.5 pl-1">
              {[
                "A duplicate or accidental double charge for the same challenge",
                "An unauthorized charge on your payment method",
                "A confirmed technical error that prevented your account from being delivered",
              ].map((item) => (
                <li key={item} className="flex items-start gap-2.5 text-sm leading-6 text-zinc-300">
                  <span className="mt-1.5 h-1 w-1 flex-shrink-0 rounded-full bg-[#D4AF37]" />
                  {item}
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.15 }}>
            <h2 className="text-lg font-extrabold text-white">How to Request a Review</h2>
            <p className="mt-3 text-sm leading-7 text-zinc-400">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.2 }} className="text-center">
